...
function NoContentMessage({ children, message, defaultHeight = 200, }) {
    ...
    return (react_1.default.createElement(card_1.default, { withCustomBody: true },
        react_1.default.createElement(CardBody_1.default, { className: classes.messageContainer }, message ? (react_1.default.createElement(Text_1.default, { "data-testid": test_helpers_1.default('no', 'data', 'found'), variant: "subtitle2" }, message)) : (children))));
}
