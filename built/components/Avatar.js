...
const Avatar = ({ displayName = '', diameter = 48, fontSize = 18, onClick, className }) => {
    ...
    return (react_1.default.createElement("div", { "data-testid": test_helpers_1.default('user', 'menu'), className: clsx_1.default(avatar, className, { 'read-only': readOnly }), onClick: onClick }, displayName.charAt(0)));
};
