...
function QuantitySelector({ id, value, onChange, className, disabled = false, iconSize = 'sm', min = 0, max, allowTypedInput = true, }) {
    ...
    return (react_1.default.createElement("div", { className: (0, clsx_1.default)(classes.quantitySelector, className), "data-testid": "quantity-selector" },
        react_1.default.createElement("button", { type: "button", disabled: disabled || isMinReached, className: (0, clsx_1.default)(classes.button, {
                [classes.disabledButton]: disabled || isMinReached,
            }), onClick: decrement, "data-testid": "decrement-btn" },
            react_1.default.createElement(FontAwesomeIcon_1.default, { size: iconSize, solid: true, className: (0, clsx_1.default)(classes.icon, {
        ...
        react_1.default.createElement("button", { type: "button", disabled: disabled || isMaxReached, className: (0, clsx_1.default)(classes.button, {
                [classes.disabledButton]: disabled || isMaxReached,
            }), onClick: increment, "data-testid": "increment-btn" },
            react_1.default.createElement(FontAwesomeIcon_1.default, { size: iconSize, solid: true, className: (0, clsx_1.default)(classes.icon, {
