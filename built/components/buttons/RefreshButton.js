...
const RefreshButton = ({ onRefresh }) => {
    ...
    return (react_1.default.createElement(Text_1.default, { "data-testid": (0, test_helpers_1.default)('refresh'), noWrap: true, onClick: onRefresh, component: "div", className: classes.button },
