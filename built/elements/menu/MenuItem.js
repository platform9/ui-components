...
function MenuItem(_a) {
    ...
    const content = (react_1.default.createElement(Text_1.default, Object.assign({ "data-testid": test_helpers_1.default(children[1]), variant: textVariant, component: component, className: clsx_1.default(classes.menuItem, className), onClick: !src ? handleClick : undefined }, props),
