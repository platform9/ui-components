...
function NavItem({ name, link, icon, className = undefined, open = false, isActive = false, compact = false, tooltip = false, tooltipProps = {}, activeDisplayType = 'background', }) {
    ...
    return (link === null || link === void 0 ? void 0 : link.external) ? (react_1.default.createElement(ExternalLink_1.default, { url: link.path, textDecoration: "none" },
            ...
            react_1.default.createElement(tooltip_1.default, Object.assign({ message: tooltip ? name : '' }, tooltipProps),
                react_1.default.createElement("div", { className: classes.externalLinkBody },
                    ...
                    react_1.default.createElement("div", { className: (0, clsx_1.default)(classes.navIcon) },
                        react_1.default.createElement(FontAwesomeIcon_1.default, { className: "nav-icon", title: name, size: "lg" }, "arrow-up-right-from-square"))))))) : (react_1.default.createElement(react_router_dom_1.Link, { to: link.path },
        react_1.default.createElement("li", { className: (0, clsx_1.default)(classes.navItem, className) },
            react_1.default.createElement(tooltip_1.default, Object.assign({ message: tooltip ? name : '' }, tooltipProps),
