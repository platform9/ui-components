...
const GridEmptyContent = ({ children, defaultHeight = 150, variant = 'dark', }) => {
    ...
    return (react_1.default.createElement("div", { className: messageContainer }, typeof children === 'string' ? (react_1.default.createElement(Text_1.default, { "data-testid": test_helpers_1.default('no', 'data', 'found'), variant: "subtitle2" }, children)) : (children)));
};
