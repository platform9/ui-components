...
function getGridDialogButton(DialogComponent, customDialogProps, customButtonProps = {}) {
    return (_a) => {
        ...
        const { triggerRefresh, selectedItems, clearSelectedRows } = Grid_1.useGridContext();
        const [theme] = ThemeManager_1.useCustomTheme();
        const [dialogOpened, toggleDialogOpened, setDialogOpened] = useToggler_1.default();
        const handleDialogClose = react_1.useCallback((success) => {
