...
const StyledButton = (0, styles_1.styled)('button')(({ theme }) => ({
    display: 'flex',
    alignItems: 'center',
...
const StyledIcon = (0, styles_1.styled)(FontAwesomeIcon_1.default)(({ theme }) => ({
    cursor: 'pointer',
    color: 'inherit',
    fontSize: 20,
}));
exports.default = (0, react_1.forwardRef)((_a, ref) => {
    ...
    const content = (react_1.default.createElement(StyledButton, Object.assign({ className: (0, clsx_1.default)(className, { disabled }), onClick: disabled ? undefined : onClick, ref: ref }, props),
        react_1.default.createElement(StyledIcon, { size: size, solid: solid }, icon || children)));
    if (!info) {
        return content;
    }
