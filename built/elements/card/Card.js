...
function Card({ title, children, footer = undefined, withCustomBody = false, withCustomFooter = false, className = undefined, dataTestId = 'card', }) {
    ...
    return (react_1.default.createElement("article", { "data-testid": (0, test_helpers_1.default)(dataTestId), className: (0, clsx_1.default)(classes.card, className) },
