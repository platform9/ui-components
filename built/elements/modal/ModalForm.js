...
function ModalForm(_a) {
    ...
    const submitFuncRef = react_1.useRef(null);
    const { match } = use_react_router_1.default();
    ...
    const toOpen = react_1.useMemo(() => (route ? route.pattern.match(match.url) : open), [match.url, open]);
