...
exports.generateTheme = exports.generateTypography = exports.generateColorPalette = exports.generateComponentColors = void 0;
/* eslint-disable max-len */
const ramda_1 = require("ramda");
// eslint-disable-next-line @typescript-eslint/consistent-type-assertions
function addMuiThemeColorVars(color = {}) {
    const MuiColors = {
        main: color[500],
    };
    if (color[300]) {
    ...
    return Object.assign(Object.assign({}, color), MuiColors);
}
// newComponents looks like [{ pathTo: [], value: string }]
function generateComponentColors({ components = [] }, defaultComponentStyles) {
...
function generateColorPalette({ primary, secondary, type, themeKey, colors, }) {
    ...
    return Object.assign({ type,
        ...
        }, divider: 'rgba(0, 0, 0, 0.12)', common: {
            black: '#000',
            white: '#FFF',
        } }, returnColors);
}
exports.generateColorPalette = generateColorPalette;
function generateTypography({ fontFamily = '"Roboto", "Helvetica", "Arial", sans-serif', fontSize = 14, fontWeightLight = 300, fontWeightRegular = 400, fontWeightMedium = 500, typography, }) {
    const returnTypography = typography;
    return Object.assign({ fontFamily,
        fontSize,
        fontWeightLight,
        fontWeightRegular,
        fontWeightMedium }, returnTypography);
}
exports.generateTypography = generateTypography;
function generateTheme({ palette, typography, }) {
    const MuiTypography = generateTypography(typography);
    return {
        palette: generateColorPalette(palette),
        ...
        overrides: {
            MuiTypography: Object.assign({}, typography.typography),
            MuiSvgIcon: {
                root: {
                    fontSize: '22px',
                },
