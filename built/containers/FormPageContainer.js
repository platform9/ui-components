...
const FormPageContainer = ({ children, className = undefined, footer = undefined, logoUrl, primayImgUrl, }) => {
    ...
    return (react_1.default.createElement("section", { id: clsx_1.default('form-page-container', className), className: clsx_1.default('form-page-container', classes.page) },
        ...
        react_1.default.createElement("article", { className: classes.container },
            react_1.default.createElement("div", { className: clsx_1.default('left-pane', classes.managementPlane) },
                react_1.default.createElement("img", { alt: "Platform9 Management Plane", src: primayImgUrl, className: classes.img })),
            react_1.default.createElement("div", { className: clsx_1.default('right-pane', classes.formPane) }, children)),
        footer && react_1.default.createElement("footer", { className: clsx_1.default('form-page-footer', classes.footer) }, footer)));
};
